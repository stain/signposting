...
class TestResolverA2A(unittest.TestCase):
    ...
    def test_01_describedby(self):
        ...
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/01-http-describedby-only/index.ttl")
    ...
    def test_05_describedby_citeas(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/05-http-describedby-citeas/index.ttl")
    ...
    def test_06_describedby_citeas_item(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/06-http-citeas-describedby-item/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
        self.assertEqual(1, len(s.item))
        self.assertEqual(
            s.item[0].target, "https://s11.no/2022/a2a-fair-metrics/06-http-citeas-describedby-item/test-apple-data.csv")
    ...
    def test_07_describedby_citeas_linkset(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/07-http-describedby-citeas-linkset-json/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
        self.assertEqual(1, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/07-http-describedby-citeas-linkset-json/linkset.json")
    ...
    def test_08_describedby_citeas_linkset_txt(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/08-http-describedby-citeas-linkset-txt/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
        self.assertEqual(1, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/08-http-describedby-citeas-linkset-txt/linkset.txt")
    ...
    def test_09_describedby_citeas_linkset_json_txt(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/09-http-describedby-citeas-linkset-json-txt/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
        self.assertEqual(2, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/09-http-describedby-citeas-linkset-json-txt/linkset.json")
        self.assertEqual(s.linkset[0]["type"], "application/linkset+json")
        self.assertEqual(
            s.linkset[1].target, "https://s11.no/2022/a2a-fair-metrics/09-http-describedby-citeas-linkset-json-txt/linkset.txt")
    ...
    def test_12_item_not_found(self):
        ...
        self.assertEqual(1, len(s.item))
        self.assertEqual(
            s.item[0].target, "https://s11.no/2022/a2a-fair-metrics/12-http-item-does-not-resolve/fake.ttl")
    ...
    def test_13_describedby(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/13-http-describedby-with-type/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
    ...
    def test_14_describedby_citeas_linkset_json_txt_conneg(self):
        ...
        self.assertEqual(1, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/14-http-describedby-citeas-linkset-json-txt-conneg/index.ttl")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
        # FIXME: Don't assume particular order
        self.assertEqual(2, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/14-http-describedby-citeas-linkset-json-txt-conneg/linkset")
        self.assertEqual(s.linkset[0]["type"], "application/linkset+json")
        self.assertEqual(
            s.linkset[1].target, "https://s11.no/2022/a2a-fair-metrics/14-http-describedby-citeas-linkset-json-txt-conneg/linkset")
        self.assertEqual(s.linkset[1]["type"], "application/linkset")
    ...
    def test_15_describedby_no_conneg(self):
        ...
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/15-http-describedby-no-conneg/metadata.ttl")
        self.assertEqual(
            s.describedBy[1].target, "https://s11.no/2022/a2a-fair-metrics/15-http-describedby-no-conneg/metadata.jsonld")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
    ...
    def test_16_describedby_nconneg(self):
        ...
        self.assertEqual(2, len(s.describedBy))
        self.assertEqual(
            s.describedBy[0].target, "https://s11.no/2022/a2a-fair-metrics/16-http-describedby-conneg/metadata")
        # same as above
        self.assertEqual(
            s.describedBy[1].target, "https://s11.no/2022/a2a-fair-metrics/16-http-describedby-conneg/metadata")
        self.assertEqual(s.describedBy[0]["type"], "text/turtle")
    ...
    def test_27_describedby_citeas_linkset(self):
        ...
        self.assertEqual(1, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/27-http-linkset-json-only/linkset.json")
        self.assertEqual(s.linkset[0]["type"], "application/linkset+json")
        # TODO: Check content of linkset
    ...
    def test_28_describedby_citeas_linkset_txt(self):
        ...
        self.assertEqual(1, len(s.linkset))
        self.assertEqual(
            s.linkset[0].target, "https://s11.no/2022/a2a-fair-metrics/28-http-linkset-txt-only/linkset.txt")
        self.assertEqual(s.linkset[0]["type"], "application/linkset")
        # TODO: Check content of linkset

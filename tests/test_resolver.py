...
from signposting.resolver import find_landing_page
...
class TestResolverA2A(unittest.TestCase):
    ...
    def test_01_describedby(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/01-http-describedby-only/")
    ...
    def test_04_iri(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/04-http-describedby-iri/")
    ...
    def test_05_describedby_citeas(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/05-http-describedby-citeas/")
        self.assertEqual(s.citeAs.target, 
    ...
    def test_06_describedby_citeas_item(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/06-http-citeas-describedby-item/")
        self.assertEqual(s.citeAs.target, 
    ...
    def test_07_describedby_citeas_linkset(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/07-http-describedby-citeas-linkset-json/")
        self.assertEqual(s.citeAs.target, 
    ...
    def test_08_describedby_citeas_linkset_txt(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/08-http-describedby-citeas-linkset-txt/")
        self.assertEqual(s.citeAs.target, 
    ...
    def test_09_describedby_citeas_linkset_json_txt(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/09-http-describedby-citeas-linkset-json-txt/")
        self.assertEqual(s.citeAs.target, 
    ...
    def test_10_describedby_citeas_linkset_txt(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/10-http-citeas-not-perma/")
        self.assertEqual(s.citeAs.target, 
            "https://example.org/a2a-fair-metrics/10-http-citeas-not-perma/")

    def test_11_iri_wrong_type(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/11-http-described-iri-wrong-type//")
        self.assertEqual(s.describedBy[0].target, 
    ...
    def test_12_item_not_found(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/12-http-item-does-not-resolve/")
    ...
    def test_13_describedby(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/13-http-describedby-with-type/")
    ...
    def test_14_describedby_citeas_linkset_json_txt_conneg(self):
        s = find_landing_page("https://w3id.org/a2a-fair-metrics/14-http-describedby-citeas-linkset-json-txt-conneg/")
        self.assertEqual(s.citeAs.target, 

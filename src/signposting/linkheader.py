...
import httplink
from httplink import ParsedLink, Link, parse_link_header
from urllib.parse import urljoin

SIGNPOSTING=set("author cite-as describedby type license collection".split(" "))
...
def find_signposting(headers: List[str], baseurl=None: str) -> Signposting:
